...
function makeCard(template: Omit<Card, "id">): Card {
...
export function createStarterDeck(): Card[] {
  ...
  // 9 cards total. Max possible distance: 17, max possible cost: 17
  // Base bust threshold: 10
  // Sweet spot: draw 4-5 cards safely for ~8-10 distance
}

export const CARD_CATALOG = {
  // COMMON (shop cost: 2-3 currency)
  ...
  brook_sprite: { name: "Brook Sprite", type: "water" as const,  distance: 2, cost: 1, rarity: "common" as const, abilityId: "tidal_shield", description: "-1 cost per water card drawn." },

  // UNCOMMON (shop cost: 4-6 currency)
  fire_drake:   { name: "Fire Drake",   type: "fire" as const,   distance: 5, cost: 4, rarity: "uncommon" as const, abilityId: "fire_amplifier", description: "+1 distance per other fire card this turn." },
  golem:        { name: "Golem",        type: "earth" as const,  distance: 2, cost: 1, rarity: "uncommon" as const, abilityId: "earthquake", description: "If 3+ earth cards drawn, +5 distance." },
  ...
  leviathan:    { name: "Leviathan",    type: "water" as const,  distance: 10, cost: 8, rarity: "rare" as const, abilityId: "tsunami", description: "Sets all other costs to 0, but own cost is 6." },
  nightmare:    { name: "Nightmare",    type: "shadow" as const, distance: 0, cost: 0, rarity: "rare" as const, abilityId: "gamble", description: "Distance AND cost = cards drawn × 2." },

  // LEGENDARY (boss rewards, rare events only)
  ...
  world_tree:   { name: "World Tree",   type: "earth" as const,  distance: 5, cost: 0, rarity: "legendary" as const, abilityId: "sanctuary", description: "Can't bust this turn. Score is halved." },
} as const;
